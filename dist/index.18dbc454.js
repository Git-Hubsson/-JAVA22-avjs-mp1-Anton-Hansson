...
document.querySelector("button").addEventListener("click", (event)=>{
    ...
    if (name !== "Username" && name !== "") {
        ...
        for(let i = 0; i < weapons.length; i++)images[i].addEventListener("click", (event)=>{
            event.preventDefault();
            fight(weapons[i]);
        });
...
async function fight(userWeapon) {
    ...
    if (userWeapon === "rock" && computerWeapon === "scissor") {
        userWeaponImgURL = new URL(require("7bba3816f7c0e1ce"));
        computerWeaponImgURL = new URL(require("abd0bfde9b87bde9"));
        userPoints++;
        h1Elements[1].innerText = `${name} wins!`;
    } else if (userWeapon === "rock" && computerWeapon === "paper") {
        userWeaponImgURL = new URL(require("7bba3816f7c0e1ce"));
        computerWeaponImgURL = new URL(require("149a6200d286ece8"));
        computerPoints++;
        h1Elements[1].innerText = "Computer wins!";
    } else if (userWeapon === "rock" && computerWeapon === "rock") {
        userWeaponImgURL = new URL(require("7bba3816f7c0e1ce"));
        computerWeaponImgURL = new URL(require("7bba3816f7c0e1ce"));
        h1Elements[1].innerText = "It's a tie";
    }
    if (userWeapon === "scissor" && computerWeapon === "paper") {
        userWeaponImgURL = new URL(require("abd0bfde9b87bde9"));
        computerWeaponImgURL = new URL(require("149a6200d286ece8"));
        userPoints++;
        h1Elements[1].innerText = `${name} wins!`;
    ...
    if (userWeapon === "paper" && computerWeapon === "rock") {
        userWeaponImgURL = new URL(require("149a6200d286ece8"));
        computerWeaponImgURL = new URL(require("7bba3816f7c0e1ce"));
        userPoints++;
        h1Elements[1].innerText = `${name} wins!`;
    ...
    if (computerPoints === 1) {
        ...
        round = 0;
        computerPoints = 0;
        if (userPoints > await (0, _highscore.highscore).compare()) await (0, _highscore.highscore).patch(name, userPoints);
        userPoints = 0;
    }
}

},{"./highscore":"1RvGA","7bba3816f7c0e1ce":"4CAZU","abd0bfde9b87bde9":"ibpdO","149a6200d286ece8":"3mTa3"}],"1RvGA":[function(require,module,exports) {
...
async function compare() {
    ...
    let lowestHighscore;
    for(let i = 1; i < data.length; i++)lowestHighscore = data[i].b;
...
async function patch(name, score) {
    ...
    for(let i = 1; i < data.length; i++)if (data[i].b < score) {
...
},{}],"4CAZU":[function(require,module,exports) {
module.exports = require("97f8010682a15931").getBundleURL("10Mjw") + "rock.f2c5dd62.png" + "?" + Date.now();

},{"97f8010682a15931":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"ibpdO":[function(require,module,exports) {
module.exports = require("17befde74249c6cb").getBundleURL("10Mjw") + "scissor.b34ac60f.png" + "?" + Date.now();

},{"17befde74249c6cb":"lgJ39"}],"3mTa3":[function(require,module,exports) {
module.exports = require("fc60e7a52cc3e48d").getBundleURL("10Mjw") + "paper.663eb854.png" + "?" + Date.now();

},{"fc60e7a52cc3e48d":"lgJ39"}]},["9tRox","1SICI"], "1SICI", "parcelRequire8de9")
